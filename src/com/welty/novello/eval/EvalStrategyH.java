...
@SuppressWarnings("OctalInteger") class EvalStrategyH extends EvalStrategy {
    ...
    @Override int eval(long mover, long enemy, long moverMoves, long enemyMoves, CoefficientSet coefficientSet) {
        ...
        final short[] edge3XCoeffs = slice[10];
        eval += edge3XCoeffs[Edge3XFeature.instance.orid(Edge3XTerm.instance0(mover, enemy))]
                ...
                + edge3XCoeffs[Edge3XFeature.instance.orid(Edge3XTerm.instance2(mover, enemy))]
                + edge3XCoeffs[Edge3XFeature.instance.orid(Edge3XTerm.instance3(mover, enemy))];

        final short[] row1Coeffs = slice[11];
        ...
        final short[] row2Coeffs = slice[12];
        ...
        final short[] row3Coeffs = slice[13];
        ...
        final short[] diagonal8Coeffs = slice[14];
        ...
        final short[] diagonal7Coeffs = slice[15];
        ...
        final short[] diagonal6Coeffs = slice[16];
        ...
        final short[] diagonal5Coeffs = slice[17];
        ...
        final short[] diagonal4Coeffs = slice[18];
        ...
        final short[] CornerBlockCoeffs = slice[19];
        ...
        final short[] Corner2x5Coeffs = slice[20];
    ...
    public static void main(String[] args) {
        final EvalStrategyH h = (EvalStrategyH) EvalStrategies.strategy("h");
        System.out.println(h.generateCode());
    }
}
