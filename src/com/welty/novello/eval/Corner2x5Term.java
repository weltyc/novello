...
public class Corner2x5Term extends Term {
    final boolean isRow;
    final boolean isLeft;
    final int row;

    private static final Feature myFeature = new Corner2x5Feature();
    private static final int[] base3FromBase2Rev5 = new int[32];
    static final Corner2x5Term[] terms = {
            new Corner2x5Term(0),
            new Corner2x5Term(1),
            new Corner2x5Term(2),
            new Corner2x5Term(3),
    ...
    static {
        for (int i = 0; i < 32; i++) {
            final int revI = Integer.reverse(i) >>> 27;
            base3FromBase2Rev5[i] = Base3.base2ToBase3(revI, 0);
        }
    }

    private final int position;

    public Corner2x5Term(int position) {
        super(myFeature);
    ...
    @Override String oridGen() {
        ...
        sb.append("Corner2x5Term.").append(isLeft ? "leftInstance(" : "rightInstance(");
    ...
    private static int rightBase3(int mover, int enemy) {
        return Base3.base2ToBase3(mover & 0x1F, enemy & 0x1F);
    }

    static int rightInstance(int mover0, int enemy0, int mover1, int enemy1) {
        return rightBase3(mover0, enemy0) + 243* rightBase3(mover1, enemy1);
    }

    static int leftInstance(int mover0, int enemy0, int mover1, int enemy1) {
        return leftBase3(mover0, enemy0) + 243* leftBase3(mover1, enemy1);
    }
    ...
    private static int leftBase3(int disks) {
        return base3FromBase2Rev5[ (disks >>> 3) & 0x1F];
    }
}
