...
@SuppressWarnings("OctalInteger") public class EvalStrategyJ extends EvalStrategy {
    ...
    @Override int eval(long mover, long enemy, long moverMoves, long enemyMoves, CoefficientSet coefficientSet) {
        ...
        final short[] row0Coeffs = slice[0];
        ...
        final short[] row1Coeffs = slice[1];
        ...
        final short[] row2Coeffs = slice[2];
        ...
        final short[] row3Coeffs = slice[3];
        ...
        final short[] diagonal8Coeffs = slice[4];
        ...
        final short[] diagonal7Coeffs = slice[5];
        ...
        final short[] diagonal6Coeffs = slice[6];
        ...
        final short[] diagonal5Coeffs = slice[7];
        ...
        final short[] CornerTriangleCoeffs = slice[8];
        ...
        final short[] moverMobilityCoeffs = slice[12];
    ...
    public static void main(String[] args) {
        final EvalStrategyJ e = (EvalStrategyJ) EvalStrategies.strategy("e");
